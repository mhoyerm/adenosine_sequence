...
parser = argparse.ArgumentParser(description='Search for adenosines in a roll.', usage='[options]')
...
parser.add_argument('-N', '--number', type=int, required=True, help='Insert wanted number of adenosines in a roll')
parser.add_argument('-P', '--finalpos', type=int, default=999999, help='Position of the last nucleotid of each gene to be searched for')
parser.add_argument('-I', '--initialpos', type=int, default=0, help='Position of the last nucleotid of each gene to be searched for')
